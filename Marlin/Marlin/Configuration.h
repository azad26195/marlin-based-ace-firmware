...
#define RAPIDBOT3 //RAPIDBOT2, RAPIDBOT3, PLUSBOT, RAPIDBOTMEGA , MEGABOT, XLBOT

#if defined(PLUSBOT) || defined(MEGABOT) || defined(XLBOT)  
	#define COREXY
#endif
...
#define Z_ROD_PITCH 1.25  //ForM8->1.25, For ACME leadscrew->3, For Ballscrew->4    // Enter pitch of Z rods in millimeters. Pitch = 1.25mm for directly driven M8 rods.
// ************* End MECHANICAL Calibration *************

#define PI 3.14159265359


  #define DEFAULT_AXIS_STEPS_PER_UNIT    {32,64,1839,94.8}  // {X, Y, Z, E}53.637 default steps per unit,z = 1280*16/12 = 
