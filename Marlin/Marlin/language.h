...
#define PROTOCOL_VERSION "1.0"
	...
	#define FIRMWARE_URL "http://3dprint.elettronicain.it/"
		...
		#define MACHINE_NAME CUSTOM_MENDEL_NAME
                    ...
                    #define MACHINE_NAME "RapidBot2"
                #elif defined(RAPIDBOT3)
                    #define MACHINE_NAME "RapidBot3"
                #elif defined(PLUSBOT)
                    #define MACHINE_NAME "PlusBot"
                #elif defined(RAPIDBOTMEGA)
                    #define MACHINE_NAME "RapidBotMega"
                #elif defined(MEGABOT)
                    #define MACHINE_NAME "MegaBot"
                #elif defined(XLBOT)
                    #define MACHINE_NAME "XLBOT"
                #endif
	#endif
