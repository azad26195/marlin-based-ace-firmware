...
//#define DualExtruderBoard //Comment this out if you want to use DualExtruderBoard
...
#if MOTHERBOARD == 33
#define EXTRUDERS 2
#elif defined(DualExtruderBoard) && MOTHERBOARD == 81
#define EXTRUDERS 3
#else
#define EXTRUDERS 1
#endif
...
#define PID_MAX 190 // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  #define PID_dT 0.128//((16.0 * 8.0)/(F_CPU / 64.0 / 256.0)) //sampling period of the

// If you are using a preconfigured hotend then you can use one of the value sets by uncommenting it


// MakeMendel Hotend with Cartridge Heater 
...
//Change the MachineName as per your requirement
#define MAXBOT //RAPIDBOT2, RAPIDBOT3, PLUSBOT, RAPIDBOTMEGA , MEGABOT, XLBOT, MAXBOT

#if defined(PLUSBOT) || defined(MEGABOT) || defined(XLBOT)  || defined(MAXBOT)  
	#define COREXY
#endif
...
#if defined(PLUSBOT) || defined(MEGABOT) || defined(XLBOT) && !defined(DISABLE_MAX_ENDSTOPS)
  #define DISABLE_MAX_ENDSTOPS
#endif
...
#elif defined(RAPIDBOT3) || defined(RAPIDBOTMEGA)
  #define INVERT_X_DIR false    // for Mendel set to false, for Orca set to true  
  #define INVERT_Y_DIR true   // for Mendel set to true, for Orca set to false
  #define INVERT_Z_DIR true     // for Mendel set to false, for Orca set to true
#elif defined(PLUSBOT) || defined(MEGABOT) || defined(XLBOT)
...
#if defined(RAPIDBOT2) || defined(RAPIDBOT3) || defined(PLUSBOT)
...
#define HOMING_FEEDRATE {2000, 2000, 200, 0}  // set the homing speeds (mm/min)
...
#define BOLT_DIAMETER 9.5         	// Enter measured diameter of hobbed bolt or pinch wheel
#define EXTRUDER_GEAR_RATIO 1  	// Enter gear ratio of extruder. Wade's Extruder: 39/11, Accessible Wade's by Greg Frost: 43/10, Adrian's Extruder: 59/11, etc.

#define BELT_PITCH 2				// Enter pitch of X and Y belts in millimeters (space from tooth to tooth). XL belts = 5.08mm
#define GEAR_TEETH 20
				// Enter number of teeth on X and Y gears

#define Z_ROD_PITCH 4  //ForM8->1.25, For ACME leadscrew->3, For Ballscrew->4    // Enter pitch of Z rods in millimeters. Pitch = 1.25mm for directly driven M8 rods.
...
#else
  #define DEFAULT_AXIS_STEPS_PER_UNIT    {80,80, 200*16/Z_ROD_PITCH,90.946}  // {X, Y, Z, E}53.637 default steps per unit,z = 1280*16/12 = 
#endif
